...
| Layer | Source |
|--|--|
| REST API controllers | [REST folder](src/main/java/com/dmitrykornilov/pets/rest) |
| Service | [ClinicServiceImpl.java](src/main/java/com/dmitrykornilov/pets/service/ClinicServiceImpl.java) |
| JDBC | [jdbc folder](src/main/java/com/dmitrykornilov/pets/repository/jdbc) |
| JPA | [jpa folder](src/main/java/com/dmitrykornilov/pets/repository/jpa) |
| Spring Data JPA | [springdatajpa folder](src/main/java/com/dmitrykornilov/pets/repository/springdatajpa) |
| Tests | [AbstractClinicServiceTests.java](src/test/java/org/springframework/samples/petclinic/service/petsService/AbstractClinicServiceTests.java) |
